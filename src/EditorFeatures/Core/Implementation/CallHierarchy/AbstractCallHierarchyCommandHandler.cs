...
{
    internal class AbstractCallHierarchyCommandHandler : VSC.ICommandHandler<ViewCallHierarchyCommandArgs>
    {
        ...
        public VSC.CommandState GetCommandState(ViewCallHierarchyCommandArgs args)
        {
